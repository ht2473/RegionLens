...
urlpatterns = [
    ...
    path("account/exports/clear/", cabinet.export_history_clear, name="account_exports_clear"),
    path(
        "account/views/bulk-delete/",
        cabinet.saved_views_bulk_delete,
    ...
    path(
        ...
        cabinet.favorites_bulk_delete,
        name="favorites_bulk_delete",
    ),
    ...
    path("account/activity/clear/", cabinet.activity_clear, name="account_activity_clear"),
