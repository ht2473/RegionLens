"""Сигналы приложения core (Ф10·3, Ф10·7).

- Авто-создание операционного профиля при появлении пользователя: каждому `User`
  гарантированно сопоставляется `UserProfile` (на это рассчитывает кабинет, Ф10·5).
- Аудит входа/выхода: сигналы auth пишут событие в журнал (Ф10·7).
