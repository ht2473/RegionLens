...
Архитектура «двух миров»: DuckDB-файл пишет ТОЛЬКО офлайн-конвейер, а
...
Прогнозирование (ранее — отдельная стадия конвейера) намеренно исключено из плана:
платформа усиливается описательно-диагностической аналитикой без предсказаний.
"""
...
def _stage_twins(duckdb_path: str, sources_path: str, log_mlflow: bool) -> None:
    """Статистические двойники: косинусная близость z-профилей по годам → top-N на регион-год."""
...
def _stage_rank_robustness(duckdb_path: str, sources_path: str, log_mlflow: bool) -> None:
    """Коридор ранга региона по схемам весов в году (чувствительность к выбору весов)."""
    from pipeline.rank_robustness import run_rank_robustness
