"""Переходы между типами и траектории регионов.

Ранжирование и переходы: ранг типов по уровню развития (dev_index) + переходы год-к-году.
Траектории: дескрипторы траектории региона (нач./кон. ранг, число смен), типология
траекторий прозрачными правилами и запись таблицы transitions в DuckDB.
Отдельно: SHAP-объяснение направления перехода.
